...
Some of these items may be deleted. If the they are (and not replaced), and are map-time data (like shader or textures) they need to go into the Nexuiz compatibility package.
