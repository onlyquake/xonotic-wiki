...
* Three of the impulses (77, 144 and 145) are listed on the OUNS wiki and appear to be deprecated
...
-77: Return the flag you are carrying and teleport to the position you put a g_waypointsprite_personal (found on OUNS wiki)

99: Grants all weapons, 999 ammo, health, and armor (needs sv_cheats 1)

100: Tetris (needs Tetris mode to compiled in)
...
-144: Prints info about surface (needs sv_cheats 1) (found on OUNS wiki)
-145: Distance between you and crosshair (needs sv_cheats 1) (found on OUNS wiki)
