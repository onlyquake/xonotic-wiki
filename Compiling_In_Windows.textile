...
This is an updated version of the outdated [[Outdated Compiling in Windows|Compiling in Windows]] page. There are no more automated tools in this version of the guide.
