...
</pre>where x can be any key (any letter or number (0-9), pgup, pgdn, alt etc.)
...
h1. Using the demo camera

The demo camera can be enabled with
<pre>
camera_enable 1
</pre>It will by default follow the player and let you move the camera around.

h2. Camera modes

h3. Chase mode (default)
...
<pre>
toggle camera_reset
</pre>(to mand1nga: why is this a cvar, not a command?)
