...
|Ignis(3 versions)|Human|Humanoid|"1":http://dev.xonotic.org/issues/39|NA|COMPLETED|COMPLETED|Fix most|INCOMPLETE|INCOMPLETE|Fix/improve animations|Oblivion, tZork, DiaboliK, theShadow|IN PROGRESS|diabolik/ignisplayermodel|{{div_start_tag(a3,red)}}HIGH{{div_end_tag}}|
|Gak|Alien|Humanoid|NA|NA|COMPLETED|IN PROGRESS|None|INCOMPLETE|INCOMPLETE|Textures/Animations|Oblivion, tZork, DiaboliK|IN PROGRESS|NA|{{div_start_tag(a4,red)}}HIGH{{div_end_tag}}|
