...
This unexpected development severed the trust between the Nexuiz community and the maintainer, AlienTrap[link], who used its status to sell the game to IllFonic. When it became clear that the deal is finalized, a large portion of the community joined together to create Xonotic[link] and continue development under a new name. We firmly believe that under the existing circumstances this is the only way that allows the project to remain free, open-source and community-based.
