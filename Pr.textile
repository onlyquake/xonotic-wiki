...
While we don't have a specific timeline for the first release under the new title, you can track the progress and updates on the new website [link] and on IRC:

#xonotic on irc.quakenet.org - general discussion
#xonotic on irc.freenode.org - development discussion

#xonotic.editing - content development // don't mention in the news article but add to wiki
#xonotic.pickup - match finding (still in works) // don't mention in the news article but add to wiki
