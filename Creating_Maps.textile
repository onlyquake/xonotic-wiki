...
You can compile your map locally or on the build server.  The build server (requires [[Respository Access]]) requires a <mapname>.mapoptions file. For more info check ask in #xonotic.editing on irc.quakenet.org
