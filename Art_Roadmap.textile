...
|Umbra|Human|Humanoid|"1":http://dev.xonotic.org/issues/25|NA|COMPLETED|IN PROGRESS|Fix duckwalk|INCOMPLETE|INCOMPLETE|Improve animations, Merge pants to glow|Oblivion, tZork, DiaboliK|IN PROGRESS|diabolik/umbraplayermodel|{{div_start_tag(a1,red)}}HIGH{{div_end_tag}}|
|Pyria|Human|Humanoid|NA|NA|COMPLETED|IN PROGRESS|Fix duckwalk|INCOMPLETE|INCOMPLETE|Improve animtaions, Merge pants to glow|Oblivion, tZork, DiaboliK|IN PROGRESS|diabolik/pyriaplayermodel|{{div_start_tag(a2,red)}}HIGH{{div_end_tag}}|
|Ignis(3 versions)|Human|Humanoid|"1":http://dev.xonotic.org/issues/39|NA|COMPLETED|COMPLETED|Fix most|INCOMPLETE|INCOMPLETE|Fix/improve animations|Oblivion, tZork, DiaboliK|IN PROGRESS|diabolik/ignisplayermodel|{{div_start_tag(a3,red)}}HIGH{{div_end_tag}}|
