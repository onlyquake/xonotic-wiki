...
h1. NetRadiant - A Stabilized Q3 Map Editor
...
p(clearbefore). NetRadiant is a fork of the well-known map editor for Q3 based games, "GtkRadiant 1.5":http://zerowing.idsoftware.com/viewcvs/radiant/GtkRadiant/branches/1.5/. The focus is put on stabilizing and bugfixing the included map compiler, q3map2, so it can become a reliable tool for map authors.
...
Note that ZeroRadiant game packs will _not_ work.
