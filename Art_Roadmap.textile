...
|Umbra|Human|Humanoid|"1":http://dev.xonotic.org/issues/25|NA|COMPLETED|IN PROGRESS|Fix duckwalk|INCOMPLETE|INCOMPLETE|Improve animations, Merge pants to glow|Oblivion, tZork, DiaboliK|IN PROGRESS|diabolik/umbraplayermodel|{{div_start_tag(foo,red)}}HIGH{{div_start_tag(foo,red)}}|
